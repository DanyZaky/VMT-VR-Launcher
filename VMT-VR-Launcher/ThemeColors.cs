...
{
    /// <summary>
    /// Centralized color palette for the dark navy blue premium theme.
    ...
    public static class ThemeColors
    {
        ...
        public static readonly Color AccentBlueSoft    = Color.FromArgb(40, 59, 130, 246); // Subtle glow
        ...
        public static readonly Color BorderAccent      = Color.FromArgb(100, 59, 130, 246); // Accent glow
        ...
        // ─── Status Colors ───────────────────────────────────────────
        public static readonly Color StatusOnline      = Color.FromArgb(34, 197, 94);    // Green dot
        public static readonly Color StatusOffline     = Color.FromArgb(239, 68, 68);    // Red dot
        public static readonly Color StatusWarning     = Color.FromArgb(249, 115, 22);   // Orange dot

        // ─── Fonts ───────────────────────────────────────────────────
        public static readonly Font FontTitle          = new("Poppins", 16f, FontStyle.Bold);
        public static readonly Font FontSubtitle       = new("Poppins", 9.5f, FontStyle.Regular);
        public static readonly Font FontLabel          = new("Poppins", 9f, FontStyle.Bold);
        public static readonly Font FontBody           = new("Poppins", 9.5f, FontStyle.Regular);
        public static readonly Font FontSmall          = new("Poppins", 8.5f, FontStyle.Regular);
        public static readonly Font FontButton         = new("Poppins", 9.5f, FontStyle.Bold);
        public static readonly Font FontMono           = new("Cascadia Code", 9f, FontStyle.Regular);
        public static readonly Font FontVersion        = new("Poppins", 11f, FontStyle.Bold);
        public static readonly Font FontInfoValue      = new("Poppins", 9.5f, FontStyle.Regular);
        public static readonly Font FontSectionTitle   = new("Poppins", 10f, FontStyle.Bold);
    }
}
